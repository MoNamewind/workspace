package com.bj58.mail.apache.utils;
...
public class MailUtil {
	...
	public static void main(String[] args) {
		...
		mail.setSender("1324226933@qq.com");
		mail.setReceiver("liushujin01@58ganji.com"); // 接收人
		mail.setUsername("1324226933@qq.com"); // 登录账号,一般都是和邮箱名一样吧
		mail.setPassword("89190505?abc"); // 发件人邮箱的登录密码
